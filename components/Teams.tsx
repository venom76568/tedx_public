  ...
  licensee: [
    {
      ...
      linkedin: "https://www.linkedin.com/in/tanvi-malode-5744a4258?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    }
  ...
  curators: [
    {
      ...
      linkedin: "https://www.linkedin.com/in/sudhanshu-tiwari-843ba525b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      name: "APURVA UGALE", 
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/anshul-mukati-643a15285?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
  ],
  marketinghead: [
    {
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/aquib-iqbal-shaikh-042504253?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      name: "ANUJ SINGH", 
  ...
  brandhead: [
    {
      ...
      linkedin: "https://www.linkedin.com/in/bhakti-umarkar-101754282?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      name: "ANURAG TIWARI", 
      ...
      linkedin: "https://www.linkedin.com/in/anurag-tiwari-172a59250?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    }
  ],
  technicalhead: [
    {
  ...
  executiveTeam: [
    {
      ...
      linkedin: "https://www.linkedin.com/in/sahil-gawade-4b0716286?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      name: "SHOBHIT", 
      ...
      linkedin: "https://www.linkedin.com/in/shobhit-kumar-singh-135844338?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      name: "RUDRA AGRAWAL", 
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/ayushi-priyadarshini-001aa027b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      name: "CHETAN KASABE", 
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/ritesh-meshram-b80b13343?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    }, 
  ],
  marketingTeam: [
    {
      ...
      linkedin: "https://www.linkedin.com/in/pratyush-kumar-90aaa4284?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app ",
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/yashashwi-kumar-3b4953312?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/ujjawal-asthana-50925a203?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      name: "ILYAS PITHEWAN", 
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/pragya-chakravarty-a82209327?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app ",
    }
  ],
  brandTeam: [
    {
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/sujal-burade-28787a30a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app ",
    }
  ],
  techTeam: [
    {
  ...
  return (
    <div className="bg-black p-8">
      {Object.entries(teamMembers).map(([teamKey, members]) => {
        const teamName = teamCategoryNames[teamKey] || teamKey.charAt(0).toUpperCase() + teamKey.slice(1);
        return (
  ...
  {teamName}
            ...
            <div className="flex flex-wrap justify-center gap-8 mx-auto w-full max-w-screen-xl">
              {members.map((member, index) => (
                <div className="flex justify-center w-full md:w-1/2 lg:w-1/3 xl:w-1/4" key={index}>
